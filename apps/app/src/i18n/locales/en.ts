...
export default {
  ...
  "settings.scheduled_new_coming_soon_hint": "The full create/edit dialog ships in the next slice. Toggle existing jobs above to see the live scheduler in action.",
