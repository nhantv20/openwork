...
export default {
  ...
  "settings.tab_description_artifacts": "View and manage generated artifacts from your sessions.",
  ...
  "settings.tab_artifacts": "Artifacts",
  "settings.tab_general": "Settings",
  "settings.tab_recovery": "Recovery",
  "settings.tab_skills": "Skills",
  "settings.tab_scheduled": "Scheduled tasks",
  "settings.tab_description_scheduled": "Run prompts on a schedule in this workspace.",
  "settings.scheduled_section_title": "Scheduled tasks",
  "settings.scheduled_section_description": "Prompts that run on a schedule in this workspace.",
  "settings.scheduled_new_button": "New task",
  "settings.scheduled_new_coming_soon": "Creating scheduled tasks is coming soon",
  "settings.scheduled_new_coming_soon_hint": "Open Settings → Scheduled tasks to manage your jobs.",
  "settings.scheduled_loading": "Loading scheduled tasks…",
  "settings.scheduled_load_failed": "Failed to load scheduled tasks: {message}",
  "settings.scheduled_toggle_failed": "Could not update job",
  "settings.scheduled_toggle_aria": "Enable {name}",
  "settings.scheduled_empty_title": "No scheduled tasks yet",
  "settings.scheduled_empty_description": "Create a task to run a prompt on a cron schedule in this workspace.",
  "settings.scheduled_empty_create_button": "Create your first scheduled task",
  "settings.scheduled_requires_server": "Connect the OpenWork server to manage scheduled tasks.",
  "settings.scheduled_dialog_title_new": "New scheduled task",
  "settings.scheduled_dialog_title_edit": "Edit scheduled task",
  "settings.scheduled_dialog_description": "Pick a cron expression and timezone. The next 3 runs are previewed live.",
  "settings.scheduled_field_name": "Name",
  "settings.scheduled_field_name_placeholder": "Daily report",
  "settings.scheduled_field_prompt": "Prompt",
  "settings.scheduled_field_prompt_placeholder": "Summarise today's git log",
  "settings.scheduled_field_cron": "Cron expression",
  "settings.scheduled_field_timezone": "Timezone",
  "settings.scheduled_field_agent": "Agent",
  "settings.scheduled_field_agent_description": "OpenCode agent that runs this task. \"build\" can edit files and run tools; \"plan\" is read-only.",
  "settings.scheduled_agent_build": "build (default — can edit files)",
  "settings.scheduled_agent_plan": "plan (read-only)",
  "settings.scheduled_field_model": "Model",
  "settings.scheduled_field_model_description": "OpenCode model to use. Leave on the workspace default unless this job needs a different LLM.",
  "settings.scheduled_model_default_option": "Use workspace default",
  "settings.scheduled_model_default_placeholder": "Workspace default",
  "settings.scheduled_model_default_badge": "default",
  "settings.scheduled_next_run": "Next: {when}",
  "settings.scheduled_create_saved": "Scheduled task created",
  "settings.scheduled_edit_saved": "Scheduled task updated",
  "settings.scheduled_save_failed": "Could not save scheduled task",
  "settings.scheduled_edit_button_short": "Edit",
  "settings.scheduled_delete_button_short": "Delete",
  "settings.scheduled_edit_button_aria": "Edit scheduled task",
  "settings.scheduled_run_now": "Run now",
  "settings.scheduled_run_triggered": "Run triggered",
  "settings.scheduled_run_failed": "Could not trigger run",
  "settings.scheduled_delete_succeeded": "Scheduled task deleted",
  "settings.scheduled_delete_failed": "Could not delete scheduled task",
  "settings.scheduled_recent_runs": "Recent runs",
  "settings.scheduled_no_runs_yet": "No runs yet.",
  "settings.scheduled_run_status_pending": "Pending",
  "settings.scheduled_run_status_running": "Running",
  "settings.scheduled_run_status_success": "Success",
  "settings.scheduled_run_status_failed": "Failed",
  "settings.scheduled_run_status_skipped": "Skipped (catch-up window)",
  "settings.scheduled_run_status_skipped_overlap": "Skipped (previous run still in flight)",
  "settings.scheduled_open_session": "Open session {id}",
  "settings.scheduled_health_running": "Scheduler running",
  "settings.scheduled_health_offline": "Scheduler offline",
  "settings.scheduled_health_offline_hint": "The in-process scheduler isn't running on this server. Start a standalone scheduler (or relaunch openwork-server without --disable-scheduler) so cron jobs can fire.",
  "settings.scheduled_search_placeholder": "Search tasks…",
  "settings.scheduled_filter_all": "All",
  "settings.scheduled_filter_enabled": "Enabled",
  "settings.scheduled_filter_disabled": "Disabled",
  "settings.scheduled_next_runs_preview": "Next: {when}",
  "settings.scheduled_no_runs_match": "No tasks match your search.",
  ...
  "skills.filter_global": "Global",
  "skills.scope_workspace": "Workspace",
  "skills.scope_global": "Global",
  "skills.global_label": "Read-only",
  "skills.new_button_label": "New skill",
  "skills.new_button_hint": "Create a new workspace skill from a starter template.",
  "skills.new_dialog_title": "Create a new skill",
  "skills.new_dialog_desc": "Skills live in `.opencode/skills/<name>/SKILL.md`. You can edit and refine the content after creation.",
  "skills.new_dialog_name_label": "Name",
  "skills.new_dialog_name_hint": "Lowercase letters, digits, `-` and `_` only. Must be unique in this workspace.",
  "skills.new_dialog_name_ok": "Name is available.",
  "skills.new_dialog_name_invalid": "Use lowercase letters, digits, `-`, or `_`.",
  "skills.new_dialog_name_taken": "A skill with that name already exists.",
  "skills.new_dialog_description_label": "Description",
  "skills.new_dialog_description_placeholder": "One sentence describing what this skill does.",
  "skills.new_dialog_description_hint": "Also written into the frontmatter so the engine can decide when to invoke it.",
  "skills.new_dialog_preview_label": "SKILL.md preview",
  "skills.new_dialog_preview_empty": "Pick a valid name to preview the generated file.",
  "skills.new_dialog_preview_path": ".opencode/skills/{name}/SKILL.md",
  "skills.new_dialog_create": "Create skill",
  "skills.new_dialog_created": "Created skill `{name}`.",
  "skills.detail_load_failed": "Failed to load the skill file.",
  "skills.detail_load_failed_title": "Could not open skill",
  "skills.detail_readonly_label": "Read-only",
  "skills.detail_readonly_hint": "Global skills live outside the workspace. OpenWork manages them as read-only here.",
  "skills.detail_view_only": "View",
  "skills.detail_tab_content": "Content",
  "skills.detail_tab_permissions": "Permissions",
  "skills.detail_tab_tools": "External tools",
  "skills.detail_tab_metadata": "Metadata",
  "skills.detail_source_label": "Source",
  "skills.detail_editor_label": "Editor",
  "skills.detail_preview_label": "Preview",
  "skills.detail_unsaved_changes": "Unsaved changes",
  "skills.detail_empty_body_title": "Nothing to preview yet",
  "skills.detail_empty_body_desc": "Add a heading and some instructions, then save to see them rendered here.",
  "skills.detail_permissions_allowed_tools": "Allowed tools",
  "skills.detail_permissions_no_tools": "No tool allow-list declared. The skill can run with whatever the model asks for.",
  "skills.detail_permissions_edit_hint": "Edit `allowed-tools:` in the frontmatter (Content tab) to constrain which tools the skill can use.",
  "skills.detail_permissions_model": "Preferred model",
  "skills.detail_permissions_no_model": "Inherits the worker's default model.",
  "skills.detail_permissions_trigger": "Trigger phrase",
  "skills.detail_permissions_no_trigger": "No explicit trigger phrase.",
  "skills.detail_tools_empty_title": "No external tool references",
  "skills.detail_tools_empty_desc": "The body does not reference any `$tool` placeholders. Add things like `$bash` or `$mcp-linear` to wire it up.",
  "skills.detail_tools_referenced_title": "Tool references in body",
  "skills.detail_tools_referenced_hint": "Found by scanning the skill body for `$tool-name` placeholders. The engine substitutes these at runtime.",
  "skills.detail_tools_count": "{count} tools",
  "skills.detail_tools_uses": "{count}× referenced",
  "skills.detail_metadata_title": "Skill metadata",
  "skills.detail_meta_name": "Name",
  "skills.detail_meta_scope": "Scope",
  "skills.detail_meta_path": "File path",
  "skills.detail_meta_description": "Description",
  "skills.detail_meta_category": "Category",
  "skills.detail_meta_trigger": "Trigger phrase",
  "skills.detail_meta_model": "Model",
  "skills.detail_meta_frontmatter_keys": "Frontmatter keys",
  "skills.detail_body_chars": "{count} characters",
  "skills.trigger_label_inline": "Trigger: {trigger}",
  ...
  "workspace_list.quick_actions_coming_soon": "Soon",
  "workspace_list.quick_actions_coming_soon_hint": "Coming in a future release - see WBS Phase 3.",
  "workspace_list.quick_actions_connect_mobile": "Connect Mobile",
  "workspace_list.quick_actions_connect_mobile_coming_soon": "Connect Mobile is coming soon",
  "workspace_list.quick_actions_new_task": "New task",
  "workspace_list.quick_actions_new_task_no_workspace": "Select a workspace first to create a new task.",
  "workspace_list.quick_actions_scheduled": "Scheduled",
  "workspace_list.quick_actions_scheduled_coming_soon": "Scheduled tasks are coming soon",
  "workspace_list.quick_actions_search": "Search",
  "workspace_list.quick_actions_skills": "Skills",
  "workspace_list.quick_actions_skills_coming_soon": "Skills are coming soon",
  ...
  // Phase 6.9: Review Tab — approval workflow strings.
  "review.tab_label": "Review",
  "review.tab_label_pending": "Review ({count} pending)",
  "review.changes.title": "Changes",
  "review.changes.empty.title": "No pending changes",
  "review.changes.empty.subtitle": "Agent edits will appear here for review.",
  "review.changes.approve_one": "Approve",
  "review.changes.reject_one": "Reject",
  "review.changes.approve_all": "Approve all",
  "review.changes.reject_all": "Reject all",
  "review.changes.bulk_summary": "{approved} approved, {failed} failed",
  "review.changes.view_diff": "View diff",
  "review.changes.hide_diff": "Hide",
  "review.changes.large_file_warning": "Large file (~{size})",
  "review.changes.truncated": "Diff truncated — showing first {shown} lines. {action}",
  "review.changes.truncated_view_full": "View full",
  "review.changes.no_parent": "No pre-AI snapshot; cannot reject",
  "review.changes.initial_version": "Initial version — no pre-AI snapshot to diff against.",
  "review.changes.error.title": "Failed to load pending changes",
  "review.changes.error.retry": "Retry",
  "review.history.title": "History",
  "review.history.empty.title": "No history yet",
  "review.history.empty.subtitle": "Agent snapshots will appear here.",
  "review.history.filter.all": "All",
  "review.history.filter.pending": "Pending",
  "review.history.filter.approved": "Approved",
  "review.history.filter.rejected": "Rejected",
  "review.history.status.approved": "Approved",
  "review.history.status.rejected": "Rejected",
  "review.history.status.pending": "Pending",
  "review.history.status.legacy": "Legacy",
  "review.history.load_more": "Load more",
  "review.history.end": "End of history",
  "review.diff.title": "Diff",
  "review.diff.empty.title": "No file selected",
  "review.diff.empty.subtitle": "Approve / reject a file from the Changes tab first.",
  "review.diff.file_label": "File",
  "review.diff.ref_label": "Pre-AI → Current",
  "review.diff.large_warning": "Large file ({size}): {path}. Diff may be slow to render.",
  "review.diff.truncated": "Diff truncated — showing first {shown} of {total} lines.",
  "review.diff.no_changes": "No changes to display.",
  "review.error_boundary.title": "Review panel failed to load",
  "review.error_boundary.retry": "Reload",
  "review.error.no_parent_snapshot": "Snapshot expired, cannot reject. File left as-is.",
} as const;
