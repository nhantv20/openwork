...
DATA = [
    ...
    ["4.0", "Phase 3: Scheduled Tasks ❌ NONE", "未着手", "高", "Nhân",
     "", "", "", 38, 0, "", "cron", "MỚI — cần xây từ đầu",
     "🔗 aionui:packages/desktop/src/renderer/pages/cron/ (toàn bộ folder AionUi)"],
    ["4.1", "DB migration: cron_jobs table", "未着手", "高", "Nhân",
     "", "", "", 2, 0, "", "cron,db", "Schema: id, user_id, cron_expr, prompt, enabled...",
     "🔗 aionui:/cron/cronUtils.ts\n📄 ee/packages/den-db/drizzle/ (pattern migration)"],
    ["4.2", "Cron runner service (croner)", "未着手", "高", "Nhân",
     "", "", "", 8, 0, "4.1", "cron,runner", "Bun server + croner npm",
     "🔗 aionui:packages/desktop/src/renderer/pages/cron/components/CronJobManager.tsx"],
    ["4.3", "CRUD API routes", "未着手", "高", "Nhân",
     "", "", "", 4, 0, "4.1", "cron,api", "GET/POST/PUT/DELETE /api/cron",
     "🔗 aionui:/cron/useCronJobs.ts\n📄 apps/server/src/routes/sessions.ts (pattern)"],
    ["4.4", "Settings UI page", "未着手", "高", "Nhân",
     "", "", "", 12, 0, "4.3", "cron,ui", "Create/edit/enable/disable",
     "🔗 aionui:/cron/ScheduledTasksPage/index.tsx\n🔗 aionui:/cron/ScheduledTasksPage/CreateTaskDialog.tsx"],
    ["4.5", "Execution engine + conversation relay", "未着手", "高", "Nhân",
     "", "", "", 8, 0, "4.2", "cron,exec", "Gửi prompt đúng lịch",
     "🔗 aionui:/cron/components/CronJobManager.tsx"],
    ...
    ["7.0", "Phase 6: Version History ⚠️ EARLY (5%)", "未着手", "高", "Nhân",
     "", "", "", 26, 5, "", "history", "PRIORITY CAO NHẤT — building blocks có sẵn",
    ...
    ["7.3", "Audit trail", "完了", "高", "Nhân",
     ...
     "📄 apps/server/src/services/audit.ts"],
    ["7.4", "DB migration: file_snapshots", "未着手", "高", "Nhân",
     "", "", "", 2, 0, "", "history,db", "Schema: id, workspace_id, file_path, content_hash, content, created_at, trigger",
     "🔗 aionui:.../hooks/usePreviewHistory.ts (schema pattern)"],
    ["7.5", "Auto-snapshot on save middleware", "未着手", "高", "Nhân",
     "", "", "", 4, 0, "7.4", "history,snapshot", "Snapshot content trước ghi đè",
     "🔗 aionui:packages/desktop/src/process/utils/snapshotService.ts (ước lượng)"],
    ["7.6", "History API route", "未着手", "高", "Nhân",
     "", "", "", 4, 0, "7.4", "history,api", "GET list + POST restore",
     "📄 apps/server/src/routes/files.ts (pattern)"],
    ["7.7", "History UI dropdown", "未着手", "高", "Nhân",
     "", "", "", 8, 0, "7.6", "history,ui", "Danh sách version + restore button",
     "🔗 aionui:.../Preview/components/.../PreviewHistoryDropdown.tsx"],
    ["7.8", "Diff compare 2 versions", "未着手", "中", "Nhân",
     "", "", "", 4, 0, "7.2,7.6", "history,diff", "So sánh bất kỳ 2 snapshot",
     "📄 diff-viewer.tsx (đã có) + API mới"],
...
summary_data = [
    ...
    ["3. Scheduled Tasks", "❌ NONE (0%)", "0/7", 38],
    ["4. Remote Access", "⚠️ EARLY (15%)", "1/3", 44],
    ["5. File Tree", "✅ DONE (85%)", "6/8", 120],
    ["6. Version History", "⚠️ EARLY (5%)", "3/8", 26],
